...
//                        .hasAuthority(UserRole.USER_ADMIN.name()))
...
//                        .hasAnyAuthority(UserRole.USER_ADMIN.name(), UserRole.USER_SUPPORT.name()))
//                .authorizeHttpRequests(auth -> auth.requestMatchers(HttpMethod.POST, "/cards")
//                        .hasAnyAuthority(UserRole.TRADER_TEAM_LEADER.name(), UserRole.TRADER_TEAM.name()))
