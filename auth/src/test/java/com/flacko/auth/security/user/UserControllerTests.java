...
public class UserControllerTests {
    ...
    public void testListUsers() throws Exception {
        ...
        userService.create()
                ...
                .withRole(Role.TRADER_TEAM_LEADER)
                .build();
        userService.create()
                .withLogin("testUser5")
                .withPassword("testPassword5")
                .withRole(Role.TRADER_TEAM)
                .build();
        ...
        mockMvc.perform(get("/users"))
                ...
                .andExpect(jsonPath("$[2].role", is(Role.MERCHANT.name())))
                ...
                .andExpect(jsonPath("$[3].role", is(Role.TRADER_TEAM_LEADER.name())))
                ...
                .andExpect(jsonPath("$[4].role", is(Role.TRADER_TEAM.name())))
